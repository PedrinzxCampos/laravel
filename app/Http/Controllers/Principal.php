...
class Principal extends Controller
{
    ...
    function produtos(){
        ...
        $produtos = [
            ...
            "produto12" => ["id" => 12, "nome" => "microfone", "preco"=> 350],
            "produto13" => ["id" => 13, "nome" => "roteador", "preco"=> 180],
            "produto14" => ["id" => 14, "nome" => "HD externo", "preco"=> 400],
            "produto15" => ["id" => 15, "nome" => "pendrive", "preco"=> 80],
            "produto16" => ["id" => 16, "nome" => "placa de vídeo", "preco"=> 1500],
            "produto17" => ["id" => 17, "nome" => "memória RAM", "preco"=> 300],
            "produto18" => ["id" => 18, "nome" => "processador", "preco"=> 1200],
            "produto19" => ["id" => 19, "nome" => "gabinete", "preco"=> 250],
            "produto20" => ["id" => 20, "nome" => "fonte de alimentação", "preco"=> 350],
            "produto21" => ["id" => 21, "nome" => "cooler", "preco"=> 120]
        ];
